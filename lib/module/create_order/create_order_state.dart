...
class _CreateOrderViewState extends TTState<_CreateOrderModel, _CreateOrderView> {
  @override
  Widget buildWithModel(BuildContext context, _CreateOrderModel model) {
    return Scaffold(
      body: Stack(
        children: [
          Container(
